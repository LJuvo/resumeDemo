		...
		<!--content-->
			...
			<div class="col9 docs-body">
				...
				<div id="caigouInfo" class="col9 cshow">
					...
					<table class="table table-bordered">
						<?php
							$sqlname="car_procurement";
							$result_caigou=mysql_fetch_row(mysql_query("SELECT * FROM car_procurement WHERE carOId='$plateId'"));
							if($result_caigou!=null){
							echo"<form action='reviseInfo.php?commId=$plateId&sql=$sqlname&actionD=rev' method='post'>
							<tbody><tr>
							<td>车辆采购</td><td></td></tr></tbody><tbody><tr>
							<td>车辆种类</td><td><input name='idClas' value='$result_caigou[4]'/></td>
							<td>车辆新旧</td><td><input name='idCate' value='$result_caigou[2]'/></td></tr><tr>
							<td>车辆品牌</td><td><input name='idBran' value='$result_caigou[6]'/></td>
							<td>车辆型号</td><td><input name='idType' value='$result_caigou[5]'/></td></tr><tr>
							<td>车辆编号</td><td><input name='' value='$result_caigou[1]'/></td>
							<td>销售单位</td><td><input name='idSaUn' value='$result_caigou[8]'/></td></tr><tr>
							<td>销售人员</td><td><input name='idSaPe' value='$result_caigou[9]'/></td>
							<td>联系电话</td><td><input name='idPhon' value='$result_caigou[10]'/></td></tr><tr>
							<td>厂商指导价</td><td><input name='idFaPr' value='$result_caigou[11]'/></td>
							<td>采购价格</td><td><input name='idPurch' value='$result_caigou[12]'/></td></tr><tr>
							<td>购买方式</td><td><input name='idBuWay' value='$result_caigou[13]'/></td>
							<td>采购人员</td><td><input name='idBuPer' value='$result_caigou[14]'/></td></tr><tr>
							<td>财务审核人</td><td><input name='idFinPer' value='$result_caigou[18]'/></td>
							<td>审核意见</td><td><input name='idFinOpn' value='$result_caigou[19]'/></td></tr><tr>
							<td>审核时间</td><td><input name='idFinDate' value='$result_caigou[20]'/></td>
							<td>经理审核人</td><td><input name='idMan' value='$result_caigou[21]'/></td></tr><tr>
							<td>审核意见</td><td><input name='idMaOpn' value='$result_caigou[22]'/></td>
							<td>审核时间</td><td><input name='idMaDate' value='$result_caigou[23]'/></td></tr><tr>
							<td colspan='4'><input type='submit' class='btn bg-inverse bg-blue' value='修改'>
							</td></tr></tbody></form>";
							}
						?>
					</table>
					...
					<div id="sf">
						...
						<table class="table table-bordered">
							...
							if($commentKey=="K"){
								...
								<td>姓名</td><td><input name='carNamI' value='$result_chezhu[2]'/></td>
								<td>性别</td><td><input name='carSeI' value='$result_chezhu[3]'/></td></tr><tr>
								<td>民族</td><td><input name='carNatioI' value='$result_chezhu[4]'/></td>
								<td>出生</td><td><input name='carBirthdaI' value='$result_chezhu[5]'/></td></tr><tr>
								<td>住址</td><td><input name='carAddresI' value='$result_chezhu[6]'/></td>
								<td>公民身份证号码</td><td><input name='carNuI' value='$result_chezhu[7]'/></td></tr><tr>
								<td>签发机关</td><td><input name='carOriganizatioI' value='$result_chezhu[8]'/></td>
								<td>有限期限</td><td><input name='carUsefulDatI' value='$result_chezhu[9]'/></td></tr><tr>
								<td>联系电话</td><td colspan='3'><input name='carPhonI' value='$result_chezhu[10]'/></td></tr>
								<tr><td colspan='4'><input type='submit' class='btn bg-blue bg-inverse' value='修改'></td>
								</tr></tbody></form>";
								}else{
									echo"<form action='reviseInfo.php?commId=$plateId&sql=$sqlname&actionD=add' method='post'>
								<tbody><tr><td>车主信息</td><td></td></tr></tbody><tbody><tr>
								...
								<tr><td colspan='4'><input type='submit' class='btn bg-blue bg-inverse' value='添加'></td>
								</tr></tbody></form>";
								}
							}
							if($commentKey=="C"){
								...
								if($result_chezhuC[0]!=null){
									echo"<form action='reviseInfo.php?commId=$plateId&sql=$sqlname&actionD=rev' method='post'>
							<tbody><tr><td>车主信息</td><td></td></tr></tbody><tbody><tr>
							<td>统一社会信用代码</td><td><input name='czSCodR' value='$result_chezhuC[2]'/></td></tr><tr>
							<td>名称</td><td><input name='czNamR' value='$result_chezhuC[3]'/></td></tr><tr>
							<td>类型</td><td><input name='czTypR' value='$result_chezhuC[4]'/></td></tr><tr>
							<td>住所</td><td><input name='czAddresR' value='$result_chezhuC[5]'/></td></tr><tr>
							<td>法定代表人</td><td><input name='czRepresenR' value='$result_chezhuC[6]'/></td></tr><tr>
							<td>注册资本</td><td><input name='czReCapitaR' value='（人民币）$result_chezhuC[7]'/></td></tr><tr>
							<td>成立日期</td><td><input name='czUpDatR' value='$result_chezhuC[8]'/></td></tr><tr>
							<td>营业期限</td><td><input name='czUsefulDatR' value='$result_chezhuC[9]'/></td></tr><tr>
							<td>经营范围</td><td><input name='czScopR' value='$result_chezhuC[10]'/></td></tr><tr>
							<td>登记机关</td><td><input name='czOrganizatioR' value='$result_chezhuC[11]'/></td></tr><tr>
							<td>发证日期</td><td><input name='czReleaseDatR' value='$result_chezhuC[12]'/></td></tr><tr>
							<td>联系电话</td><td><input name='czPhonR' value='$result_chezhuC[13]'/></td></tr>
							<tr><td colspan='4'><input type='submit' class='btn bg-blue bg-inverse' value='修改'></td>
								</tr></tbody></form>";
								}else{
									echo"<form action='reviseInfo.php?commId=$plateId&sql=$sqlname&actionD=add' method='post'>
				...
				<div id="baoxianInfo" class="col9 cshow">
					...
					<table class="table table-bordered">
						...
						if($result_baoxian[0]!=null){
							...
							<td>险种名称</td><td><input name='bxNamI' value='$result_baoxian[2]'/></td>
							<td>承保公司</td><td><input name='bxCompanI' value='$result_baoxian[3]'/></td></tr><tr>
							<td>保单号</td><td><input name='bxNumbeI' value='$result_baoxian[4]'/></td>
							<td>保险金额</td><td><input name='bxAmounI' value='$result_baoxian[5]'/></td></tr><tr>
							<td>车船税金额</td><td><input name='bxTaI' value='$result_baoxian[6]'/></td>
							<td>有效期</td><td><input name='bxUsefulDatI' value='$result_baoxian[7]'/></td></tr>
							<tr><td colspan='4'><input type='submit' class='btn bg-blue bg-inverse' value='修改'></td>
							</tr></tbody></form>";
						}else{
							echo"<form action='reviseInfo.php?commId=$plateId&sql=$sqlname&actionD=add' method='post'>
				...
				<div id="zhuceInfo" class="col9 cshow">
					...
					<table class="table table-bordered">
						...
						if($result_zhuce[0]!=null){
							...
							<td>注册种类</td><td><input name='zcTypR' value='$result_zhuce[2]'/></td>
							<td>车牌号</td><td><input name='zcPlateNumbeR' value='$result_zhuce[3]'></td></tr><tr>
							<td>所有人</td><td><input name='zcOwneR' value='$result_zhuce[4]'/></td>
							<td>住址</td><td><input name='zcAddresR' value='$result_zhuce[5]'/></td></tr><tr>
							<td>发证机关</td><td><input name='zcOrganizatioR' value='$result_zhuce[6]'/></td>
							<td>注册日期</td><td><input name='zcReDatR' value='$result_zhuce[7]'/></td></tr><tr>
							<td>年检有效期至</td><td><input name='zcUsefulDatR' value='$result_zhuce[8]'/></td>
							<td>办理单位</td><td><input name='zcReUniR' value='$result_zhuce[9]'/></td></tr><tr>
							<td>办理人员</td><td><input name='zcRePersoR' value='$result_zhuce[10]'/></td>
							<td>费用名称</td><td><input name='zcCostNamR' value='$result_zhuce[11]'/></td></tr><tr>
							<td>费用金额</td><td colspan='3'><input name='zcCostAmounR' value='$result_zhuce[12]'/></td></tr>
							<tr><td colspan='4'><input type='submit' class='btn bg-blue bg-inverse' value='修改'></td>
							</tr></tbody></form>";
						}else{
							echo"<form action='reviseInfo.php?commId=$plateId&sql=$sqlname&actionD=add' method='post'>
				...
				<div id="daikuanInfo" class="col9 cshow">
					...
					<table class="table table-bordered">
						...
						if($result_loan[0]!=null){
							...
							<tr><td colspan='7'><input type='submit' class='btn bg-blue bg-inverse' value='修改'></td>
							</tr></tbody></form>";
					...
					<table class="table table-bordered">
						...
						if($res_loan!=null){
							...
							for($k=0;$k<$num_loan;$k++){
								...
								echo"<form action='reviseInfo.php?commId=$plateId&sql=$sqlname&actionD=add&actionD=rev' method='post'>
							<tbody<tr><td>设备加装</td><td colspan='3'></td></tr></tbody><tbody><tr>
							<td>加装种类</td><td><input name='equipTypA' value='$result_loan[2]'/></td>
							<td>加装类别</td><td><input name='equipClasA' value='$result_loan[3]'/></td></tr><tr>
							<td>设备品牌</td><td><input name='equipBranA' value='$result_loan[4]'/></td>
							<td>设备编号</td><td><input name='equipNuA' value='$result_loan[5]'/></td></tr><tr>
							<td>设备来源</td><td><input name='equipSourcA' value='$result_loan[6]'/></td>
							<td>加装位置</td><td><input name='equipAddresA' value='$result_loan[7]'/></td></tr><tr>
							<td>是否拆除</td><td><input name='equipIsDemolA' value='$result_loan[8]'/></td>
							<td>申请人员</td><td><input name='equipApplicanA' value='$result_loan[9]'/></td></tr><tr>
							<td>申请时间</td><td><input name='equipAppDatA' value='$result_loan[10]'/></td>
							<td>主管部门</td><td><input name='equipDeparA' value='$result_loan[11]'/></td></tr><tr>
							<td>审核意见</td><td><input name='equipOpinioA' value='$result_loan[12]'/></td>
							<td>审核时间</td><td><input name='equipDatA' value='$result_loan[13]'/></td></tr><tr>
							<td>审核人员</td><td colspan='3'><input name='equipPersoA' value='$result_loan[13]'/></td></tr>
				...
				<div id="weizhangInfo" class="col9 cshow">
					<p>
					<table class="table table-bordered">
						<tbody><tr><td colspan="13">车辆违章信息</td></tr></tbody>
						<tbody><tr>
							<td>违章时间</td>
							<td>违章内容</td>
							<td>违章地点</td>
						...
						if($res_assigned!=null){
							...
							for($k=0;$k<$num_assigned;$k++){
								...
								$violaId=$result_assigned[0];
								echo"<form action='reviseInfo.php?commId=$plateId&sql=$sqlname&actionD=rev&violaId=$violaId' method='post'>
							<tbody><tr>
							<td><input name='violaTimI' value='$result_assigned[2]'/></td>
							<td><input name='violaInfI' value='$result_assigned[3]'/></td>
							<td><input name='violaPlacI' value='$result_assigned[4]'/></td>
							<td><input name='violaFineI' value='$result_assigned[5]'/></td>
							<td><input name='violaDeducI' value='$result_assigned[6]'/></td>
							<td><input name='violaDriveI' value='$result_assigned[7]'/></td>
							<td><input name='violaStatI' value='$result_assigned[8]'/></td>
							<td><input name='violaOrgaI' value='$result_assigned[9]'/></td>
							<td><input name='violaPersoI' value='$result_assigned[10]'/></td>
							<td><input name='violaProChaI' value='$result_assigned[11]'/></td>
							<td><input name='violaTotalChaI' value='$result_assigned[12]'/></td>
							<td><input name='violaCosI' value='$result_assigned[13]'/></td>
							<td><input type='submit' class='btn bg-blue bg-inverse' value='修改'></td>
							</tr></tbody></form>";
							}
						}
							echo"<form action='reviseInfo.php?commId=$plateId&sql=$sqlname&actionD=add' method='post'>
							...
							<td><input name='violaCost'/></td><td></td></tr>
							<tr><td colspan='13'><input type='submit' class='btn bg-blue bg-inverse' value='添加'></td>
							</tr></tbody></form><tbody><tr><td colspan='12'></td></tr></tbody>";
					...
					<table class="table table-bordered">
						...
						if($res_rtolls!=null){
							...
							for($k=0;$k<$num_rtolls;$k++){
								...
								$tollsId=$result_rtolls[0];
								echo"<form action='reviseInfo.php?commId=$plateId&sql=$sqlname&actionD=rev&type=燃油费&tollsId=$tollsId' method='post'>
								<tbody>
						<tr>
							<td>燃油费</td>
						...
						<tbody>
							<tr><td colspan='12'><input type='submit' class='btn bg-blue bg-inverse' value='修改'></td>
							</tr></tbody></form><tbody><tr><td colspan='12'></td></tr></tbody>";
							}
						}
						echo"<form action='reviseInfo.php?commId=$plateId&sql=$sqlname&actionD=add&type=燃油费' method='post'>
							<tbody>
						<tr>
							<td>燃油费</td>
				...
				<div id="guoluInfo" class="col9 cshow">
					...
					<table class="table table-bordered">
						...
						echo"<form action='reviseInfo.php?commId=$plateId&sql=$sqlname&actionD=add&type=过路费' method='post'>
							<tbody>
						<tr>
							<td>过路费</td>
				...
				<div id="tingcheInfo" class="col9 cshow">
					...
					<table class="table table-bordered">
						...
						echo"<form action='reviseInfo.php?commId=$plateId&sql=$sqlname&actionD=add&type=停车费' method='post'>
							<tbody>
						<tr>
							<td>停车费</td>
