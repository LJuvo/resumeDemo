					...
					<table class="table table-bordered" style="text-align:center" id="addNewTable">
						...
						<tr>
							<td colspan="4" style="text-align: right">
								<input name="orderType" value="燃油业务" readonly="true" style="border: 0px;text-align: right"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2">燃油种类</td>
							<td colspan="2" style="text-align: left;"><select name="oilType">
