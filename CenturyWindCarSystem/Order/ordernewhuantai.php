			...
			<div class="row">
				...
				<div class="col9 docs-body" id="main_content">
					...
					<table class="table table-bordered" style="text-align:center" id="addNewTable">
						...
						<!--<tr>-->
							<!--<td><input type="radio" name="optionsRadios" value="option1" style="width: auto;margin-right: 5px;">-->
								<!--拖车业务</input></td>-->
							<!--<td><input type="radio" name="optionsRadios" value="option2" style="width: auto;margin-right: 5px;">-->
								<!--搭电业务</input></td>-->
							<!--<td><input type="radio" name="optionsRadios" value="option2" style="width: auto;margin-right: 5px;">-->
								<!--更换备胎</td>-->
							<!--<td><input type="radio" name="optionsRadios" value="option2" style="width: auto;margin-right: 5px;">-->
						...
						<tr>
							<td colspan="4" style="text-align: right">
								<input name="orderType" value="换胎业务" readonly="true" style="border: 0px;text-align: right"/>
							</td>
						</tr>
						<tr>
