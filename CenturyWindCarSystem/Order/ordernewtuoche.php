			...
			<table class="table table-bordered" style="text-align:center" id="addNewTable">
				...
				<tr>
					<td colspan="4" style="text-align: right">
						<input name="orderType" value="拖车业务" readonly="true" style="border: 0px;text-align: right"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2">目的地名</td>
					<td colspan="2"><input name="destinationName"/></td>
				</tr>
				<tr>
					<td colspan="2">目的地址</td>
					<td colspan="2"><input name="destinationAddress"/></td>
				</tr>
				<tr>
					<td colspan="2">目的电话</td>
					<td colspan="2"><input name="destinationTel"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="4"><input type="submit" class="btn bg-blue bg-inverse"/></td>
				</tr>
				</tbody>
			</table>
			</form>
