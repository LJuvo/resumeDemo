	...
	<div class="row">
		...
		<div class="col9 docs-body" id="main_content">
				...
				<tr><td><a href='ordercancelexcepinforevise.php?Id=$orderId'>信息修改</a></td>
					<td class='selected'><a href='ordercancelexcepinfo.php?Id=$orderId'>订单状态修改</a></td>
					<td><a href='#'>取消订单</a></td></tr>
			</table>
			<table class='table table-bordered' style='text-align:center'>
				...
				<tr>
					<td><a class='btn bg-blue bg-inverse' href='cancelorder.php?Id=$orderId'>取消</a></td>
				</tr>";
				?>
				<tr>
					<td rowspan="2"></td>
