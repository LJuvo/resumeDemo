		...
		<div class="col9 docs-body" id="main_content">
			<div id="expend">
				...
				<table class="table table-bordered" style="text-align:center">
					<form action="expendwipe.php?numId=5" method="post">
						<tbody>
						<tr><td>费用报销</td><td colspan="3"></td></tr>
						<tr><td rowspan="10">报销基本信息</td><td>报销种类</td><td colspan="3">招待费报销</td></tr>
						...
						<tr><td>接待地址</td><td colspan="3"><input name="entertainAddress" placeholder="公司"/></td></tr>
						<tr><td>接待单位</td><td colspan="3"><input name="entertainCompany" placeholder="IT开发"/></td></tr>
						<tr><td>被招待单位</td><td colspan="3"><input name="entertainForCompany" placeholder="三方开发公司"/></td></tr>
						<tr><td>被招待人员</td><td colspan="3"><input name="entertainForPerson" placeholder="钟敏"/></td></tr>
