...
?>
	...
	<script type="text/javascript">
		...
		function addTableCell(cellTable, i) {
			...
			newRow.insertCell(5).innerHTML = '<a href="../employee/employee_info.php?e_ID='+cellTable[i].id+'">查看</a>';
			newRow.insertCell(6).innerHTML = '<a href="../employee/employee_revise.php?e_ID='+cellTable[i].id+'">修改</a>';
			newRow.insertCell(7).innerHTML = '<a href="?e_ID='+cellTable[i].id+'">删除</a>';
...
//		$query="SELECT * FROM employer_idcard";
